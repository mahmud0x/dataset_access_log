...
import random
fake = Faker()
request_url = ["GET /registration HTTP/1.1","GET /login HTTP/1.1","GET /api/login HTTP/1.1","GET /api/registration HTTP/1.1","GET /redeem HTTP/1.1"]
useragent = [
...
randIp_prefix=['203.30.140','203.32.120','185.238.228','45.12.30','45.12.31','203.30.190','141.101.123','31.43.179']
request_url
def generate_random_ip(num):
    return '.'.join(
        str(randint(0, 255)) for _ in range(num)
    )
def my_func1(): #testcase same ip_range
    if fake.pybool(): #same ip range with same useragent and url
      random_request_url = random.choice(request_url)
      random_useragent = random.choice(useragent)
      for i in range(30):
        random_country = random.choice(countries)
        random_ip = generate_random_ip(1)
        print(random.choice(randIp_prefix) + '.' + random_ip + '~' + random_country[1] + '~' + random_useragent + '~' + random_request_url+'~'+"Function1-1")
    for i in range(30): #testcase: same ip range but diff useragent and url
      random_country = random.choice(countries)
      random_ip = generate_random_ip(1)
      print(random.choice(randIp_prefix) + '.' + random_ip + '~' + random_country[
        1] + '~' + random.choice(useragent) + '~' + random.choice(request_url)+'~'+"Function1-2")
def my_func2():
    for i in range(30):
        random_country = random.choice(countries)
        random_ip = generate_random_ip(4)
        print(random_ip+','+random_country[1]+'~'+random.choice(useragent)+ '~' + random.choice(request_url)+'~'+"Function2")
def my_func3(): #testcase same ip_same request url_same useragent
    for i in range(20):
        random_ip = generate_random_ip(4)
        random_country = random.choice(countries)
        random_useragent =random.choice(useragent)
        ...
        if fake.pybool():
            for i in range(randint(3,7)):
                print(random_ip+'~'+random_country[1]+'~'+random_useragent+ '~' + random_request_url+'~'+"Function3")
def my_func4(): #testcase completely random
    for i in range(30):
        random_country = random.choice(countries)
        print(fake.ipv4()+'~'+random_country[1]+'~'+random.choice(useragent)+ '~' + random.choice(request_url)+'~'+"Function4")
my_func_list=[my_func1,my_func2,my_func3,my_func4]
for i in range(100):
    random.choice(my_func_list)()
